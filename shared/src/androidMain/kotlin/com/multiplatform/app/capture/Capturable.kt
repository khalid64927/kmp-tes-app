...
private class CapturableModifierNode(
    ...
    override fun onAttach() {
        ...
        coroutineScope.launch {
            println("onAttach launch ")
            controller.captureRequests.collect { request ->
                println("Capturable.android.kt")
                println("Capturable request")
                ...
                try {
                    ...
                    println("Capturable request end")
                } catch (error: Throwable) {
                    println("Capturable error ${error}")
